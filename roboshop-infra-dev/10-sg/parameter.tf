...
# resource "aws_ssm_parameter" "backend_alb_sgid" {
#   name  = "/${var.project}/${var.environment}/backend_ald_sgid"
#   type  = "String"
...
# resource "aws_ssm_parameter" "frontend_frontend_alb" {
#   name  = "/${var.project}/${var.environment}/frontend_frontend_alb"
#   type  = "String"
#   value = module.frontend.sg_id
# }


# resource "aws_ssm_parameter" "frontend_alb_http" {
#   name  = "/${var.project}/${var.environment}/frontend_alb_http"
#   type  = "String"
#   value = module.frontend_alb.sg_id
# }

# resource "aws_ssm_parameter" "frontend_alb_https" {
#   name  = "/${var.project}/${var.environment}/frontend_alb_https"
#   type  = "String"
#   value = module.frontend_alb.sg_id
# }

# resource "aws_ssm_parameter" "frontend_alb_sgid" {
#   name = "/${var.project}/${var.environment}/frontend_alb_sgid"
#   type = "String"
#   value = module.frontend_alb.sg_id
#   overwrite = true
# }
...
# # resource "aws_ssm_parameter" "component_sg_id" {
# #   name = "/${var.project}/${var.environment}/${var.component}_sg_id"
# #  type = "String"
# #  value = module.component.sg_id
